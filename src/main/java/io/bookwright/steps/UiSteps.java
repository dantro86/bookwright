...
public class UiSteps {
    ...
    private static final List<String> DEFAULT_PRODUCT_ORDER = List.of(
            "Sauce Labs Backpack",
    ...
    public void loginAsStandardUser() {
        ...
        PlaywrightAssertions.assertThat(inventoryPage.inventoryItems()).hasCount(DEFAULT_PRODUCT_ORDER.size());
    ...
    public void addToCart(String productName) {
        ...
        PlaywrightAssertions.assertThat(inventoryPage.productActionButton(productName)).hasText("Remove");
    }
    ...
    public void checkoutAndAssertOrderComplete(String productName) {
        ...
        PlaywrightAssertions.assertThat(checkoutPage.page()).hasURL(Pattern.compile(".*/checkout-complete\\.html"));
    }
}
