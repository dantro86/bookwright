...
final class UiDiagnostics {
    ...
    synchronized void recordFailedRequest(String method, String url, String resourceType, String failure) {
        add(failedRequests, "%s %s [%s] — %s".formatted(
                method, SecretSanitizer.url(url), resourceType, failure));
    }
