...
class MainConfigTest {
    ...
    void declaresExpectedSourcePrecedence() {
        ...
        assertThat(Arrays.asList(sources.value())).containsExactly(
                "system:properties",
                "system:env",
    ...
    void declaresDocumentedDefaults() throws NoSuchMethodException {
        assertThat(MainConfig.class.getMethod("uiHeadless").getAnnotation(Config.DefaultValue.class).value())
                .isEqualTo("true");
        assertThat(MainConfig.class.getMethod("teardownFailOnError")
                .getAnnotation(Config.DefaultValue.class).value())
                .isEqualTo("true");
    }
