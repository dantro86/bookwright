...
| Decentralized fixture construction and shared test runtime | `TestFixtureRuntimeTest` |
| Owner-local JUnit keys and typed test state | `StateOwnershipArchitectureTest` |
